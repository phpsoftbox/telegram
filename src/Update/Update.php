...
final class Update
{
    ...
    public function message(): ?Message
    {
        ...
        $message = $this->payload['message'] ?? $this->callbackQuery()?->message()?->payload();
        if (!is_array($message)) {
            return null;
        }
    ...
    public function callbackQuery(): ?CallbackQuery
    {
        ...
        $callbackQuery = $this->payload['callback_query'] ?? null;
    ...
    {
        return $this->callbackQuery()?->chatId() ?? $this->message()?->chatId();
    }

    public function fromId(): ?int
    {
        return $this->callbackQuery()?->fromId() ?? $this->message()?->fromId();
    }
