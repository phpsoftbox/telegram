...
class TelegramClient
{
    ...
    public function answerCallbackQuery(string $callbackQueryId, array $options = []): TelegramResponse
    {
    ...
    public function setMyDescription(string $description, array $options = []): TelegramResponse
    {
        return $this->request('setMyDescription', ['description' => $description] + $options);
    }

    public function setMyShortDescription(string $shortDescription, array $options = []): TelegramResponse
    {
        return $this->request('setMyShortDescription', ['short_description' => $shortDescription] + $options);
    }

    public function deleteMyCommands(array $options = []): TelegramResponse
    {
