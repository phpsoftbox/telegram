...
- flow engine для централизованного описания переходов и guard-условий;
...
$router->onCallbackData('trial:start', fn ($update, $context) => ...);
$router->onCallbackQuery(fn ($update, $context) => ...);
...
- [Flow Engine](docs/08-flow.md)
- [Scenario Builder](docs/09-scenario-builder.md)
